...
HD_PWD='C:/Users/ugnjhjf/Desktop/COMP/Computer_Organization_CPU_Design/Vivado/Vivado_Tutorial/FourBItAdder_with_IP/FourBItAdder_with_IP.runs/adderrr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adderrr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adderrr.tcl
