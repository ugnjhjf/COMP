...
HD_PWD='C:/Users/ugnjhjf/Desktop/COMP_P/Computer_Organization_CPU_Design/Vivado/31CPU_new/31CPU_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU31.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU31.tcl
