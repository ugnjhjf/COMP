...
HD_PWD='C:/Users/ugnjhjf/Desktop/COMP_P/Computer_Organization_CPU_Design/Vivado/31CPU_new/31CPU_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU31.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU31.tcl -notrace
